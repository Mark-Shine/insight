...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'AlarmRecord.word' to match new field type.
        db.rename_column(u'monitor_alarmrecord', 'word', 'word_id')
        # Changing field 'AlarmRecord.word'
        db.alter_column(u'monitor_alarmrecord', 'word_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monitor.Words'], null=True))
        # Adding index on 'AlarmRecord', fields ['word']
        db.create_index(u'monitor_alarmrecord', ['word_id'])


    def backwards(self, orm):
        # Removing index on 'AlarmRecord', fields ['word']
        db.delete_index(u'monitor_alarmrecord', ['word_id'])


        # Renaming column for 'AlarmRecord.word' to match new field type.
        db.rename_column(u'monitor_alarmrecord', 'word_id', 'word')
        # Changing field 'AlarmRecord.word'
        db.alter_column(u'monitor_alarmrecord', 'word', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'monitor.alarmrecord': {
            ...
            'word': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['monitor.Words']", 'null': 'True', 'blank': 'True'})
        },
        u'monitor.contact': {

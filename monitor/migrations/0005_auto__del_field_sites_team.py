...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sites.team'
        db.delete_column(u'monitor_sites', 'team_id')

        # Adding M2M table for field team on 'Sites'
        m2m_table_name = db.shorten_name(u'monitor_sites_team')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sites', models.ForeignKey(orm[u'monitor.sites'], null=False)),
            ('team', models.ForeignKey(orm[u'monitor.team'], null=False))
        ))
        db.create_unique(m2m_table_name, ['sites_id', 'team_id'])


    def backwards(self, orm):
        # Adding field 'Sites.team'
        db.add_column(u'monitor_sites', 'team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['monitor.Team'], null=True, blank=True),
                      keep_default=False)

        # Removing M2M table for field team on 'Sites'
        db.delete_table(db.shorten_name(u'monitor_sites_team'))
